...
(function() {
  ...
  let config = {
    apiEndpoint: 'https://app.funneldoctor.io/api/touchpoints',
  ...
  function identifyLead(leadData = {}) {
    ...
    // Enregistrer l'u00e9vu00e9nement de conversion
    trackEvent('lead_identified', {
      ...leadData,
      conversion_timestamp: new Date().toISOString()
    });
    
    console.log('Visiteur identifiu00e9 comme lead:', leadData);
